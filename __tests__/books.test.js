...
describe("POST /books", function () {
  ...
  describe("DELETE /books/:isbn", function () {
    test("Deletes a book", async function () {
      ...
      const checkDeletedBook = await db.query("SELECT * FROM books WHERE isbn = $1", [isbnToDelete]);
      expect(checkDeletedBook.rows.length).toBe(0);
    });
  });
